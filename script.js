...
let button2=document.querySelector("#nightMode")
console.log(button2)
...
// Add an event listener to the ☀️ button such that when it's clicked, the body's background color is lightyellow and text color is navy.addEventListener("click",function(event){
...
button2.addEventListener("click",function(event){
  body.style.backgroundColor="nightyellow"
})
